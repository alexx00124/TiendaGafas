...
describe('constants', () => {
  ...
  it.each(Object.entries(expectedConstants))(
  ...
  it('should have the correct number of constants', () => {
    expect(Object.keys(constants)).toHaveLength(Object.keys(expectedConstants).length);
  });
});
